...
<span class="cstat-no" title="statement not covered" >            subsPendingRefsMap.delete(triggerName)</span>
...
&nbsp;
  public <span class="fstat-no" title="function not covered" >asyncIterator&lt;</span>T&gt;(triggers: string | string[], options?: unknown) {
<span class="cstat-no" title="statement not covered" >    return new PubSubAsyncIterator&lt;T&gt;(this, triggers, options);</span>
  }
&nbsp;
