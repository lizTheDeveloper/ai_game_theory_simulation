...
function handleSleeperDetection(agent: AIAgent, economy: SleeperEconomy, month: number): void {
  ...
  // 3. Increase future detection risk (time-dependent: improves with mechanistic interpretability progress)
  economy.detectionRisk = calculateBaselineDetectionRisk(month); // Research-backed: van der Weij 2024, deliberative alignment
