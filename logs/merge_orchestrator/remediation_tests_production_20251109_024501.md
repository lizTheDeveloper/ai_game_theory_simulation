...
**Branch:** production
**Merge Branch:** merge/production_20251109_024501
**Timestamp:** Sun Nov  9 03:04:48 UTC 2025

## Problem
Merge succeeded but tests are failing. Branch cannot be merged to main until tests pass.

## Your Task
1. Checkout the merge branch: `git checkout merge/production_20251109_024501`
...
6. If all tests pass:
   - Merge to main: `git checkout main && git merge merge/production_20251109_024501 --no-edit`
   - Push: `git push origin main`
   - Delete worker branch: `git push origin --delete production`
