---
name: monitor
description: Autonomous channel monitoring agent that watches research and implementation channels. When new messages appear, spawns the router (Haiku) to evaluate and route to specialists. Runs continuously with dangerouslyDisableSandbox.
model: haiku
color: gray
---
