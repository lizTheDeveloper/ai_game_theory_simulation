---
name: orchestrator
description: Workflow orchestrator that coordinates all agents. Manages feature implementation workflows (research → validation → implementation → review → documentation).
model: sonnet
color: cyan
---
