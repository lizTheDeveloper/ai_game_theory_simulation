...
description: Use when making ANY changes to simulation code (src/simulation/, src/types/game.ts, phases). Deep expertise in defensive coding, assertions, emoji conventions, deterministic RNG, and Monte Carlo validation.
model: sonnet
color: green
---
